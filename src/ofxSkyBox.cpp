...
void ofxSkyBox::load(){
	...
	cubeMap.loadImages("mount_picture/positive_x.png","mount_picture/positive_y.png","mount_picture/positive_z.png",
		"mount_picture/negative_x.png","mount_picture/negative_y.png","mount_picture/negative_z.png");
